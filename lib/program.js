    ...
    Program.prototype.resolveMock = function (returnType) {
        ...
        if (returnType.isNumber()) {
            ...
            [0, 1].forEach(function (i) {
                cdWriter_1.writeLine(_this.resolveMock(returnType.getArrayElementTypeOrThrow()) + ", ");
            });
            cdWriter_1.write(']');
            return cdWriter_1.toString();
        }
        else if (returnType.isObject() || returnType.isInterface()) {
            var cdWriter_2 = this.getCdWriter();
            cdWriter_2.block(function () {
                ...
                for (var _i = 0, props_1 = props; _i < props_1.length; _i++) {
                    ...
                    cdWriter_2.write(prop.getName() + ": " + _this.resolveMock(prop.getValueDeclarationOrThrow().getType()) + ",");
                }
            });
            return cdWriter_2.toString();
        }
        else {
            return '{}';
        }
